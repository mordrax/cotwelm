	...
	return _elm_lang$html$Html_Attributes$style(
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_1: A2(
					_elm_lang$core$Basics_ops['++'],
					_elm_lang$core$Basics$toString(coords.y * 32),
					'px')
			},
				{
				ctor: '_Tuple2',
				...
				_1: A2(
					_elm_lang$core$Basics_ops['++'],
					_elm_lang$core$Basics$toString(coords.x * 32),
					'px')
			}
			]));
};
var _mordrax$cotwelm$Lib$Coordinate = F2(
	function (a, b) {
		return {x: a, y: b};
	});
...
var _mordrax$cotwelm$GameData_Tile$asciiToTileType = function ($char) {
	var _p0 = $char;
	switch (_p0.valueOf()) {
		case '^':
...
var _mordrax$cotwelm$Game_Data$DungeonLevel = function (a) {
	return {ctor: 'DungeonLevel', _0: a};
};
var _mordrax$cotwelm$Game_Data$DungeonLevelOne = {ctor: 'DungeonLevelOne'};
var _mordrax$cotwelm$Game_Data$Farm = {ctor: 'Farm'};
...
var _mordrax$cotwelm$GameData_ASCIIMaps$farmBuildings = _elm_lang$core$Native_List.fromArray(
	[
		{
		name: 'Farm Gate',
...
var _mordrax$cotwelm$GameData_ASCIIMaps$villageMap = _elm_lang$core$Native_List.fromArray(
	['========,,###,,,========', '========,,,.,,,,========', '========,,,.,,,,========', '========,,,.,,,,========', '========,,,.,,,,========', '===,,,,,;...,,,!###=====', '===###!;.;,.,,;.###=====', '===###..;,,.,;.;###=====', '===###,,,,,...;,,,,,,===', '===,,,,,,,,.,,,,,,,,,===', '====,,,,,,,.,,,,,,,,,===', '====,,,,,,,.,,,,,,,,,===', '====,,,,,,,.,!###,,,,===', '====,,,##.....###,,,,===', '====,,,##!,.,,###,,,,===', '====,,,,,,,.,,,,,,,,,===', '====,,,,,,,.,,,,,,,,,===', '====,,###!...!###,======', '====,,###..e..###,======', '====,,###,...,###,======', '====,,,,,,,.,,,,,,======', '====,,,,,,,.!,,,,,======', '======,,,#####,=========', '======,,,#####,=========', '======,,,#####,=========', '======,,,#####,=========', '======,,,#####,=========', '========================']);
var _mordrax$cotwelm$GameData_ASCIIMaps$getBuildings = function (area) {
	var _p0 = area;
	switch (_p0.ctor) {
		case 'Village':
			return _mordrax$cotwelm$GameData_ASCIIMaps$villageBuildings;
		case 'Farm':
			return _mordrax$cotwelm$GameData_ASCIIMaps$farmBuildings;
		default:
			return _elm_lang$core$Native_List.fromArray(
				[]);
	}
};
var _mordrax$cotwelm$GameData_ASCIIMaps$getASCIIMap = function (area) {
	var _p1 = area;
	switch (_p1.ctor) {
		case 'Village':
...
var _mordrax$cotwelm$Game_Maps$toTile = F3(
	function (y, x, tileType) {
		var pos = {x: x, y: y};
		return {pos: pos, tile: tileType, solid: false, building: _elm_lang$core$Maybe$Nothing};
	});
...
var _mordrax$cotwelm$Game_Maps$mapOneRowToTiles = F2(
	function (y, asciiRow) {
		...
		var tileTypes = A2(_elm_lang$core$List$map, _mordrax$cotwelm$GameData_Tile$asciiToTileType, asciiChars);
		return A2(_mordrax$cotwelm$Game_Maps$toTiles, y, tileTypes);
	});
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_mordrax$cotwelm$Lib$coordToHtmlStyle(tile.pos)
			]),
		_elm_lang$core$Native_List.fromArray(
			[]));
};
var _mordrax$cotwelm$Game_Maps$getMap = F2(
	function (area, model) {
		var maybeMap = A2(_elm_lang$core$Dict$get, area, model.maps);
		var _p0 = maybeMap;
		if (_p0.ctor === 'Just') {
			return _p0._0;
		} else {
...
var _mordrax$cotwelm$Game_Maps$villageMap = F2(
	function (area, model) {
		var buildingsHtml = A2(
			_elm_lang$core$List$map,
			_mordrax$cotwelm$Game_Maps$buildingToHtml,
			_mordrax$cotwelm$GameData_ASCIIMaps$getBuildings(area));
		var listOfTiles = A2(
			_elm_lang$core$List$map,
...
var _mordrax$cotwelm$Game_Maps$view = function (model) {
	return A2(_mordrax$cotwelm$Game_Maps$villageMap, model.currentArea, model);
};
var _mordrax$cotwelm$Game_Maps$initMaps = function () {
	var toTuple = function (tile) {
		return {
			ctor: '_Tuple2',
	...
	var getTiles = function (area) {
		return _mordrax$cotwelm$Game_Maps$mapToTiles(
			_mordrax$cotwelm$GameData_ASCIIMaps$getASCIIMap(area));
	};
	...
	return {
		currentArea: _mordrax$cotwelm$Game_Data$Farm,
		maps: _elm_lang$core$Dict$fromList(
			_elm_lang$core$Native_List.fromArray(
				[
					{
					ctor: '_Tuple2',
					_0: _elm_lang$core$Basics$toString(_mordrax$cotwelm$Game_Data$Village),
					_1: _elm_lang$core$Dict$fromList(
						tilesToTuples(_mordrax$cotwelm$Game_Data$Village))
				},
					{
					ctor: '_Tuple2',
					_0: _elm_lang$core$Basics$toString(_mordrax$cotwelm$Game_Data$Farm),
					_1: _elm_lang$core$Dict$fromList(
						tilesToTuples(_mordrax$cotwelm$Game_Data$Farm))
				},
					{
					ctor: '_Tuple2',
					_0: _elm_lang$core$Basics$toString(_mordrax$cotwelm$Game_Data$DungeonLevelOne),
					_1: _elm_lang$core$Dict$fromList(
						tilesToTuples(_mordrax$cotwelm$Game_Data$DungeonLevelOne))
				}
				]))
	};
}();
var _mordrax$cotwelm$Game_Maps$Model = F2(
	function (a, b) {
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_mordrax$cotwelm$Lib$coordToHtmlStyle(hero.pos)
			]),
		_elm_lang$core$Native_List.fromArray(
			[]));
};
...
var _mordrax$cotwelm$Game_Game$moveHero = F2(
	function (dir, model) {
		...
		return _elm_lang$core$Native_Utils.update(
			hero,
			{
				pos: A2(_mordrax$cotwelm$Game_Game$isTileObstructed, newPos, model) ? model.hero.pos : newPos
			});
	});
var _mordrax$cotwelm$Game_Game$update = F2(
	function (msg, model) {
		...
		return _elm_lang$core$Native_Utils.update(
			model,
			{
				hero: A2(_mordrax$cotwelm$Game_Game$moveHero, _p1._0, model)
			});
	});
var _mordrax$cotwelm$Game_Game$initGame = {name: 'A new game', hero: _mordrax$cotwelm$Hero_Hero$initHero, map: _mordrax$cotwelm$Game_Maps$initMaps};
var _mordrax$cotwelm$Game_Game$Model = F3(
	function (a, b, c) {
		return {name: a, hero: b, map: c};
	});
