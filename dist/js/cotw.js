...
var _mordrax$cotwelm$Game_Maps$getBuildings = function (area) {
	var _p1 = area;
	switch (_p1.ctor) {
		case 'Village':
...
var _mordrax$cotwelm$Game_Maps$villageMap = F2(
	function (area, model) {
		var buildingsHtml = A2(
			...
			_mordrax$cotwelm$Game_Maps$getBuildings(area));
		var listOfTiles = A2(
			_elm_lang$core$List$map,
...
var _mordrax$cotwelm$Game_Collision$thingsAtPosition = F2(
	function (pos, model) {
		...
		var buildings = _mordrax$cotwelm$Game_Maps$getBuildings(area);
...
var _mordrax$cotwelm$Game_Game$moveHero = F2(
	function (dir, model) {
		...
		return _elm_lang$core$Native_Utils.update(
			hero,
			{
				pos: A2(_mordrax$cotwelm$Game_Collision$isTileObstructed, newPos, model.map) ? model.hero.pos : newPos
			});
	});
