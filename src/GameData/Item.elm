...
newWeapon weaponType =
    case weaponType of
        BrokenSword ->
            Model (Weapon (WeaponModel 0)) "Broken Sword" 1000 5000 0 25 "BrokenSword"
...
newBelt beltType =
    case beltType of
        TwoSlotBelt ->
            Model (Belt (BeltModel 2 0 0 0 (Container.Model 2100 3100 0 0))) "Two Slot Belt" 300 300 0 0 "SlotBelt"

        ThreeSlotBelt ->
            Model (Belt (BeltModel 3 0 0 0 (Container.Model 2600 3600 0 0))) "Three Slot Belt" 300 300 0 0 "SlotBelt"

        FourSlotBelt ->
            Model (Belt (BeltModel 4 0 0 0 (Container.Model 3100 4100 0 0))) "Four Slot Belt" 300 300 0 0 "SlotBelt"

        UtilityBelt ->
            Model (Belt (BeltModel 2 4 4 0 (Container.Model 3100 4100 0 0))) "Utility Belt" 1350 1800 0 0 "UtilityBelt"

        WandQuiverBelt ->
            Model (Belt (BeltModel 2 0 0 4 (Container.Model 3100 4100 0 0))) "Wand Quiver Belt" 300 300 0 0 "WandQuiverBelt"
...
newPack packType =
    case packType of
        SmallBag ->
            Model (Pack (PackModel (Container.Model 5000 6000 0 0))) "Small Bag" 300 500 0 0 "Bag"

        MediumBag ->
            Model (Pack (PackModel (Container.Model 10000 12000 0 0))) "Medium Bag" 500 700 0 0 "Bag"

        LargeBag ->
            Model (Pack (PackModel (Container.Model 15000 18000 0 0))) "Large Bag" 900 900 0 0 "Bag"

        SmallPack ->
            Model (Pack (PackModel (Container.Model 12000 50000 0 0))) "Small Pack" 1000 1000 0 0 "Pack"

        MediumPack ->
            Model (Pack (PackModel (Container.Model 22000 75000 0 0))) "Medium Pack" 2000 1500 0 0 "Pack"

        LargePack ->
            Model (Pack (PackModel (Container.Model 35000 100000 0 0))) "Large Pack" 4000 100000 0 0 "Pack"

        SmallChest ->
            Model (Pack (PackModel (Container.Model 100000 50000 0 0))) "Small Chest" 5000 100000 0 0 "Chest"

        MediumChest ->
            Model (Pack (PackModel (Container.Model 100000 150000 0 0))) "Medium Chest" 15000 150000 0 0 "Chest"

        LargeChest ->
            Model (Pack (PackModel (Container.Model 100000 250000 0 0))) "Large Chest" 25000 250000 0 0 "Chest"

        EnchantedSmallPackOfHolding ->
            Model (Pack (PackModel (Container.Model 50000 150000 0 0))) "Enchanted Small Pack Of Holding" 5000 75000 0 0 "EnchantedPack"

        EnchantedMediumPackOfHolding ->
            Model (Pack (PackModel (Container.Model 75000 200000 0 0))) "Enchanted Medium Pack Of Holding" 7500 100000 0 0 "EnchantedPack"

        EnchantedLargePackOfHolding ->
            Model (Pack (PackModel (Container.Model 100000 250000 0 0))) "Enchanted Large Pack Of Holding" 10000 125000 0 0 "EnchantedPack"
