...
init weaponType status idStatus id =
    ...
    in
        case weaponType of
            BrokenSword ->
                make "Broken Sword" (Mass.Mass 1000 5000) "BrokenSword" (Prices 0 25) (WC 0) (d 1 6 -2)
            ...
            MorningStar ->
                make "Morning Star" (Mass.Mass 3000 9000) "MorningStar" (Prices 2160 1200) (WC 10) (d 1 10 0)
